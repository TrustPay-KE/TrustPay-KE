-- TrustPay KE - Supabase Database Setup
...
-- Insert default admin user (you'll need to create this manually in Supabase Auth)
-- This is just a placeholder - the actual user should be created through Supabase Auth
-- and then updated to have admin role

-- Create storage buckets (these need to be created manually in Supabase Dashboard)
-- kyc_documents - for KYC files
-- proof_files - for escrow proof files  
